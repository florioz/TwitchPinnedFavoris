(() => {
  ...
  const I18N_MESSAGES = {
    fr: {
      ...
      'drive.connect': 'Connexion Google',
      ...
      'drive.notConfigured': 'Connexion Google indisponible : la version install\u00e9e doit encore \u00eatre configur\u00e9e par le d\u00e9veloppeur.',
    ...
    en: {
      ...
      'drive.notConfigured': 'Google connection unavailable: this installed build still needs developer configuration.',
