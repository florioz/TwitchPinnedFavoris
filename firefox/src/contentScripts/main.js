(() => {
  ...
  const I18N_MESSAGES = {
    fr: {
      ...
      'streamerAppearance.hint': 'Change le rendu des lignes de streamers dans la sidebar sans modifier tes groupes.',
    ...
    en: {
      ...
      'streamerAppearance.style.minimal': 'Minimal',
      'streamerAppearance.hint': 'Changes streamer rows in the sidebar without changing your groups.',
